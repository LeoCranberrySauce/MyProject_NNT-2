...
const AboutUs = () => {
    return (
        <div className='about-us' id='about-us-section'>
            ...
            <div className='about-us-header'>
                ...
                <div className='about-us-text'>
                    ...
                    <h3>Vision</h3>
                        <p>Our vision is to be the most beloved food kiosk in Baguio City, known for our delicious and affordable meals, friendly service, and commitment to quality. We aim to create a welcoming environment where every customer feels valued and satisfied.</p>
                        <p>Our priority is to ensure customer satisfaction and happiness through our food and service.</p>
